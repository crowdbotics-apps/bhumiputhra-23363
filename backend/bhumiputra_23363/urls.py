"""bhumiputra_23363 URL Configuration
...
admin.site.site_header = "BhumiPuthra"
admin.site.site_title = "BhumiPuthra Admin Portal"
admin.site.index_title = "BhumiPuthra Admin"

# swagger
api_info = openapi.Info(
    title="BhumiPutra API",
    default_version="v1",
    description="API documentation for BhumiPutra App",
)
